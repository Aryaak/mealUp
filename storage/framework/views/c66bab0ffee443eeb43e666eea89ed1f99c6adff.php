...
<head>
    ...
    ?>
    <title><?php echo e($title); ?> | <?php echo $__env->yieldContent('title','Vendor forgot password'); ?></title>
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                ...
                <div class="col-lg-4 col-12 pt-5 col-md-6 order-lg-2 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <?php endif; ?>
                        <form method="POST" action="<?php echo e(url('admin/admin_forgot_password')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label for="email"><?php echo e(__('Email')); ?></label>
                                <input id="email" type="email" class="form-control" placeholder="<?php echo e(__('Please Enter Your Email')); ?>" name="email" tabindex="1" required autofocus>
                            </div>
                            ...
                            <div class="form-group text-center">
                                <a class="text-black-50" href="<?php echo e(url('vendor/login')); ?>"><?php echo e(__('Login')); ?></a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\mealUp\resources\views/vendor/vendor_profile/vendor_forgot_password.blade.php ENDPATH**/ ?>