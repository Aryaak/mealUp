...
<head>
    ...
    ?>
    <title><?php echo e($title); ?> | <?php echo $__env->yieldContent('title','Admin forgot password'); ?></title>
                    ...
                    <div class="p-4 m-3">
                        ...
                        <form method="POST" action="<?php echo e(url('admin/admin_forgot_password')); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email" class="form-control" placeholder="<?php echo e(__('Please Enter Your Email Id')); ?>" name="email" tabindex="1" required autofocus>
                            </div>
                            ...
                            <div class="form-group text-center">
                                <a href="<?php echo e(url('/')); ?>"><?php echo e(__('Login')); ?></a>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\mealUp\resources\views/admin/admin setting/admin_forgot_password.blade.php ENDPATH**/ ?>