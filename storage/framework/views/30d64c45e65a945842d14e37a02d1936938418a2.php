        ...
        <div class="sidebar-brand">
            <?php if(Auth::user()->load('roles')->roles->contains('title', 'vendor')): ?>
                ...
                <a href="<?php echo e(url('vendor/vendor_home')); ?>">
                    <img src="<?php echo e($vendor->vendor_logo); ?>" class="rounded" width="100" alt="" style="width: 100px !important;">
                </a>
                <div class="sidebar-brand sidebar-brand-sm">
                    <a href="<?php echo e(url('vendor/vendor_home')); ?>">
                        <img src="<?php echo e($vendor->vendor_logo); ?>" class="rounded" width="20" alt="" style="width: 100px !important;">
                    </a>
                </div>
            <?php endif; ?>
            ...
            <?php if(Auth::user()->load('roles')->roles->contains('title', 'admin')): ?>
                    ...
                    <a href="<?php echo e(url('admin/home')); ?>">
                        <img src="<?php echo e(url('images/upload/'.$icon)); ?>" width="100" class="mt-4">
                    </a>
...
<?php /**PATH C:\xampp\htdocs\mealUp\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>